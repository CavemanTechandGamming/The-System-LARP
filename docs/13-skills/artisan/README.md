...
## Overview
Artisan skills represent the ability to create, modify, and repair various items and materials. These skills are essential for crafting equipment, creating consumables, and maintaining gear. Each skill has its own unique requirements, processes, and quality levels.
...
### Quality Levels
Each artisan skill has five quality levels that determine the effectiveness and value of created items:
...
### Common Requirements
Each artisan skill has its own specific requirements, but all require:
...
### Level Milestones
Each level in an artisan skill represents a significant advancement in expertise:
...
- An alchemist might provide special treatments for a tailor's fabrics
