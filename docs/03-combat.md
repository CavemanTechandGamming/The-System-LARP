...
- [Core Combat Rules](#core-combat-rules)
  - [The Hold/Clarify Rule](#the-holdclarify-rule)
  - [Home Run Blows](#home-run-blows)
  - [Illegal Targets](#illegal-targets)
  - [Tripping](#tripping)
  - [Charging](#charging)
  - [Turtling](#turtling)
- [Physical Contact Rules](#physical-contact-rules)
  - [Body Contact Rule](#body-contact-rule)
  - [Opt-In Contact System](#opt-in-contact-system)
- [Combat Techniques](#combat-techniques)
  - [Drum Rolling/Machine Gunning](#drum-rollingmachine-gunning)
  - [Trapping/Pinning](#trappingpinning)
  - [Packet Delivered Attacks](#packet-delivered-attacks)
- [Equipment and Protection](#equipment-and-protection)
  - [Armor Rating System](#armor-rating-system)
...
Shields are another facet of The System combat system that is not exactly realistically portrayed. Turtling is defined as completely covering oneself behind a shield so only the head is available as a target. This is called turtling and it is illegal.
...
> **Important**: The red indicator takes precedence over any other contact permissions and must be respected without question. Players wearing the red indicator should not be asked for permission to make contact, as the answer is always no.
